...
const fallbackQuizQuestions = [
    ...
    { question: "How many days did God take to create the world?", options: ["5", "6", "7", "8"], correctAnswer: 2, difficulty: 3 },
...
function getSelectedQuestions(quizData, langKey) {
    ...
    if (unaskedShuffled.length >= maxQuestions) {
        selectedQuestions = unaskedShuffled.slice(0, maxQuestions);
    } else if (unaskedShuffled.length > 0) {
        selectedQuestions = [...unaskedShuffled];
    } else {
        // Cycle complete, reshuffle and reset asked
...
let state = {
    ...
    theme: (localStorage.getItem('myReaderTheme') === 'eternal' ? 'sepia' : (localStorage.getItem('myReaderTheme') || 'sepia')),
...
const RTL_LANGUAGES = ['text_hebrew', 'text_arabic', 'text_urdu', 'text_persian'];
...
const BIBLE_CONFIG = {
    'text': { sources: [{ type: 'BOLLS', id: 'BSB' }], copyright: "Berean Standard Bible (BSB)" }, // English
    'text_arabic': { sources: [{ type: 'GETBIBLE', id: 'arabicsv' }], copyright: "Smith and Van Dyke (Public Domain)" }, // Smith & Van Dyke
    'text_assamese': { sources: [{ type: 'HELLOAO', id: 'asm_irv' }], copyright: "Indian Revised Version (IRV) Assamese - 2019 (CC BY-SA 4.0)" },
    'text_bengali': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Bengali' }], copyright: "Public Domain / GodlyTalias" },
    'text_bhutanese': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_burmese': { sources: [{ type: 'HELLOAO', id: 'mya_jvb' }], copyright: "Public Domain (Adoniram Judson 1835)" },
    'text_chinese': { sources: [{ type: 'HELLOAO', id: 'cmn_cu1' }], copyright: "Chinese Union Version (simplified)" },
    'text_czech': { sources: [{ type: 'BOLLS', id: 'CSP09' }], copyright: "Public Domain" },
    'text_dogri': { sources: [{ type: 'LOCAL_BIBLE', path: 'dogri_bible_json' }], copyright: "Dogri NT (CC BY-SA 4.0) - Bridgeconn/Snow Mountain" },
    'text_dutch': { sources: [{ type: 'BOLLS', id: 'NLD' }], copyright: "Public Domain" },
    'text_french': { sources: [{ type: 'HELLOAO', id: 'fra_lsg' }], copyright: "Louis Segond 1910" },
    'text_german': { sources: [{ type: 'BOLLS', id: 'SCH' }], copyright: "Schlachter 1951" },
    'text_greek': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_gujarati': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Gujarati' }], copyright: "Public Domain / GodlyTalias" },
    'text_hebrew': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_hindi': { sources: [{ type: 'HELLOAO', id: 'HINIRV' }, { type: 'BOLLS', id: 'HIOV' }], copyright: "Hindi O.V. Re-edited (BSI)" },
    'text_hungarian': { sources: [{ type: 'BOLLS', id: 'RUF' }], copyright: "Public Domain" },
    'text_igbo': { sources: [{ type: 'HELLOAO', id: 'ibo_bib' }], copyright: "Public Domain" },
    'text_indonesian': { sources: [{ type: 'BOLLS', id: 'TB' }], copyright: "Public Domain" },
    'text_italian': { sources: [{ type: 'HELLOAO', id: 'ita_riv' }], copyright: "Riveduta Bibbia 1927" },
    'text_japanese': { sources: [{ type: 'BOLLS', id: 'JPKJV' }], copyright: "Colloquial Japanese" },
    'text_kannada': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Kannada' }], copyright: "Public Domain / GodlyTalias" },
    ...
    'text_korean': { sources: [{ type: 'HELLOAO', id: 'kor_old' }], copyright: "Korean Bible 1910" },
    'text_malay': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_malayalam': { sources: [{ type: 'HELLOAO', id: 'mal_irv' }, { type: 'BOLLS', id: 'MOV' }], copyright: "Malayalam Indian Revised Version" },
    'text_manipuri': { sources: [{ type: 'HELLOAO', id: 'mni_twf' }], copyright: "Meitei Bible (NT) - ebible.org" },
    'text_marathi': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Marathi' }], copyright: "Public Domain / GodlyTalias" },
    'text_mongolian': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_nagamese': { sources: [{ type: 'HELLOAO', id: 'nag_isv' }], copyright: "Indian Standard Version - Nagamese (NT) (CC BY-SA 4.0)" },
    'text_nepali': { sources: [{ type: 'BOLLS', id: 'NNRV' }], copyright: "Public Domain" },
    'text_norwegian': { sources: [{ type: 'BOLLS', id: 'DNB' }], copyright: "Public Domain" },
    'text_odia': { sources: [{ type: 'GITHUB_WLDEH', file: 'ory-irvory.json' }], copyright: "Indian Revised Version (IRV) Odia - 2021" },
    'text_oromo': { sources: [{ type: 'HELLOAO', id: 'gaz_bib' }], copyright: "Public Domain" },
    'text_polish': { sources: [{ type: 'BOLLS', id: 'BG' }], copyright: "Public Domain" },
    'text_portuguese': { sources: [{ type: 'HELLOAO', id: 'por_blj' }, { type: 'BOLLS', id: 'ARC09' }], copyright: "Bíblia Livre / Almeida" },
    'text_punjabi': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Punjabi' }], copyright: "Public Domain / GodlyTalias" },
    'text_romanian': { sources: [{ type: 'BOLLS', id: 'VDCL' }], copyright: "Public Domain" },
    'text_russian': { sources: [{ type: 'HELLOAO', id: 'rus_syn' }], copyright: "Russian Synodal" },
    'text_sanskrit': { sources: [{ type: 'HELLOAO', id: 'san_dev' }], copyright: "Public Domain" },
    'text_somali': { sources: [{ type: 'HELLOAO', id: 'som_sim' }], copyright: "Public Domain" },
    'text_spanish': { sources: [{ type: 'HELLOAO', id: 'spa_r09' }], copyright: "Reina Valera 1909" },
    'text_swahili': { sources: [{ type: 'HELLOAO', id: 'swh_ulb' }], copyright: "Swahili Unlocked Literal Bible" },
    'text_swedish': { sources: [{ type: 'GETBIBLE', id: 'swedish' }], copyright: "Swedish 1917 (Public Domain)" },
    'text_tagalog': { sources: [{ type: 'HELLOAO', id: 'tgl_ulb' }], copyright: "Tagalog Unlocked Literal Bible" },
    'text_tamil': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Tamil' }], copyright: "Public Domain / GodlyTalias" },
    'text_telugu': { sources: [{ type: 'GITHUB_GODLYTALIAS', lang: 'Telugu' }], copyright: "Public Domain / GodlyTalias" },
    'text_thai': { sources: [{ type: 'HELLOAO', id: 'tha_kjv' }], copyright: "Public Domain (Thai KJV)" },
    'text_tibetan': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_turkish': { sources: [{ type: 'HELLOAO', id: 'tur_obt' }], copyright: "Open Bible Translations (Turkish)" }, // Turkish
    // TODO: Add Urdu Bible when a reliable source becomes available
    // Checked: GetBible V2, Bolls, GodlyTalias, HelloAo - all unavailable as of 2025-01-30
    'text_urdu': { sources: [], unavailable: true, copyright: "Translation not available" },
    'text_vietnamese': { sources: [{ type: 'HELLOAO', id: 'vie_1934' }], copyright: "Vietnamese Bible 1934" },
    'text_yoruba': { sources: [{ type: 'HELLOAO', id: 'yor_bib' }], copyright: "Public Domain" }
};
...
const LOCALIZED_BIBLE_TITLES = {
    ...
    'text_manipuri': "ANOUBA WAREPNABA",
    'text_marathi': "\u092a\u0935\u093f\u0924\u094d\u0930 \u0936\u093e\u0938\u094d\u0924\u094d\u0930",
    'text_mongolian': "\u0410\u0440\u0438\u0443\u043d \u0411\u0438\u0431\u043b\u0438",
    'text_nagamese': "Nagamese Bible",
...
function loadReadingState() {
    try {
        ...
        if (stored) {
            ...
            state.theme = (readingState.theme === 'eternal') ? 'sepia' : (readingState.theme || 'sepia');
...
async function downloadCurrentBible(versionId, langKey, onProgress) {
    ...
    console.log(`[DEBUG_NIV] Loading config for langKey: ${langKey}`, config);

    const sourceObj = (config && config.sources) ? config.sources[0] : { type: 'BOLLS' };
    const sourceType = sourceObj.type;
    console.log(`[DEBUG_NIV] Selected source:`, sourceObj);
    ...
    if (loadedBible) {
        console.log(`[DEBUG_NIV] Found loadedBible in memory. ID: ${loadedBible.translationId}, Expected: ${versionId}`);
    } else {
        console.log(`[DEBUG_NIV] No loadedBible in memory.`);
    }

    // FIX: Check if the loaded bible matches the CONFIG version/source to prevent stale cache usage
    // FIX: Check if the loaded bible matches the CONFIG version/source to prevent stale cache usage
    // e.g. if we switched from BOLLS/YLT to GITHUB_ARULJOHN/Bible-niv
    let isCacheValid = false;
    if (loadedBible && loadedBible.translationId === versionId) {
        // Simple check: if we are expecting GITHUB_ARULJOHN and loaded data looks like it came from there (or just assume invalid if we changed config)
        // Ideally loadedBible should store its sourceType. For now, let's look for a mismatch.
        // If config says GITHUB_ARULJOHN but loadedBible has no 'chapters' array (as GITHUB_ARULJOHN fetches list first), or different structure...
        // Actually, the best way is to trust versionId. If I changed ID from 'ylt' to 'Bible-niv', versionId changes? 
        // script.js BIBLE_CONFIG 'text' id changed from 'ylt'/'YLT' to 'Bible-niv'. 
        // So versionId passed to this function SHOULD be 'Bible-niv' now.
        // If 'loadedBible.translationId' is still 'ylt', this check fails and we proceed to download. Good.

        // BUT, if the user already has 'text' loaded in UI, 'books['bible']' might be populated with OLD data before we reloaded?
        // We need to ensure init logic re-reads config.
        isCacheValid = true;
    }

    if (isCacheValid && loadedBible.chapters && loadedBible.chapters.length > 0) {
...
function updateOnlineStatus() {
    ...
    console.log("Network Status: " + (state.isOffline ? "Offline" : "Online"));

    // Optional: Show toast or update UI
    const loadingText = document.getElementById('loadingText');
    if (state.isOffline) {
        if (loadingText) loadingText.textContent = "Offline Mode";
        // Ensure we try to load local content if currently viewing a remote chapter that failed?
        // For now, just updating state is enough, the user navigation will trigger logic.
    } else {
        if (loadingText) loadingText.textContent = "Loading...";
        // Potentially retry downloads or reload page if it was stuck?
    }
...
async function loadLanguageData(lang) {
    // UPDATE BODY CLASS FOR GENERIC LANGUAGE STYLING
    // For Eternal Life, 'lang' is mostly the filename (e.g. 'dutch'), 
    // but we want the full key (e.g. 'text_dutch') if possible for consistency.
    // However, loadLanguageData is sometimes called with 'english' or 'spanish'.
    // Let's rely on state.currentLang if it matches, otherwise construct it.

    // Simple heuristic: if lang doesn't start with 'text_', prepend it, unless it is 'english' which maps to 'text'
    let langKeyForClass = lang;
    if (lang === 'english') langKeyForClass = 'text';
    else if (!lang.startsWith('text_')) langKeyForClass = 'text_' + lang;

    updateLanguageBodyClass(langKeyForClass);
    ...
    const url = `eternal_life_languages/${lang}.json?t=${cacheBuster}`;
    console.log(`Attempting to fetch language data from local file: ${url}`);
    ...
    try {
        ...
        try {
            ...
            console.warn(`Fetch threw error: ${fetchErr.message}.`);
            alert(`Fetch Error for ${url}: ${fetchErr.message}`);
        }
        ...
        // XHR Fallback if fetch failed to produce data
        if (!data) {
            console.log("Attempting XHR fallback for local file...");
        ...
        console.warn(`Failed to load ${lang}.json from local file (Fetch & XHR):`, e);
...
async function renderChapter(scrollPosition = 0) {
    return new Promise(async (resolve) => {
        ...
        if (state.currentBookKey === 'bible' && (!chapter.verses || chapter.verses.length === 0) && !chapter.isCover) {
            ...
            try {
                ...
                if (chapterData) {
                    ...
                    chapter.verses = chapterData.map(item => ({
                        id: item.id || `${chapter.bookName} ${chapter.chapterNumber}:${item.verse || item.verseId}`, // ensure ID
                        text: item.text
                    }));
                } else {
                    ...
                    try {
                        // translationId comes from book object, or state fallback
                        const config = BIBLE_CONFIG[state.currentLang] || {};
                        const sourceType = book.sourceType || (config.sources ? config.sources[0].type : 'BOLLS');
                        ...
                        if (chapter.apiLink) {
                            ...
                            const response = await fetch(chapter.apiLink);
                            ...
                            if (sourceType === 'HELLOAO' || sourceType === 'LOCAL_BIBLE') {
                                ...
                                if (rawData.chapter && rawData.chapter.content) {
                                    const versesContent = rawData.chapter.content.filter(item => item.type === 'verse');
                                    chapterData = versesContent.map(v => {
                                        let text = '';
                                        ...
                                        return {
                                            id: `${chapter.bookName} ${chapter.chapterNumber}:${v.number}`,
                                            verseId: v.number,
                                            verse: v.number,
                                            text: text.trim()
                                        };
                            ...
                            // Fallback to api.getChapter for sources without pre-stored links (e.g. BOLLS)
                            chapterData = await api.getChapter(translationId, chapter.bookId, chapter.chapterNumber, sourceType);
                        }

                        if (chapterData) {
                            // Populate the chapter object
                            // If chapterData is already formatted (from above block), use it.
                            if (chapterData[0] && chapterData[0].id) {
                                chapter.verses = chapterData;
                            } else {
                                // Fallback mapping for generic api.getChapter results
                                chapter.verses = chapterData.map((item, index) => ({
                                    // Use chapter.chapterNumber because item.chapter might be missing from API
                                    id: `${chapter.bookName} ${chapter.chapterNumber}:${item.verse || index + 1}`,
                                    verseId: item.verse,
                                    text: item.text
                                }));
                            }
                        ...
                        // Assuming hideLoading() is a global function or defined elsewhere
                        // If not, this line might cause an error.
                        if (typeof hideLoading === 'function') {
                            hideLoading();
                        }
                        // Fallback
                        // If main file fails, might mean it doesn't exist or network error
                        alert("Error loading book: " + err.message);

                        // Try fallback logic or show empty
                        // This line might need adjustment depending on where 'currentBook' is defined.
                        // Assuming 'book' refers to the current book object.
                        if (book) {
                            book.title = "Error";
                            book.chapters = [];
                        } else {
                            // If book itself is not found, create a placeholder
                            books[state.currentBookKey] = { title: "Error", chapters: [] };
                        }
                        dom.page.innerHTML = '<p class="error-msg">Failed to load chapter content. Check connection.</p>';
                        // renderChapter(); // This would cause an infinite loop if called here without changing state
                        // updateSidebar(); // This function is not in the provided context
                        resolve();
                        return;
                    }
                }
        ...
        setTimeout(() => {
                ...
                chapter.verses.forEach((v, index) => {
                    if (v.type === 'header') {
                        ...
                        if (state.currentBookKey === 'bible' && !v.id) {
                            v.id = `${chapter.bookName} ${chapter.chapterNumber}:${v.verse || index + 1}`;
                        ...
                        // ALSO ADD GENERIC LANG CLASS TO VERSE
                        const langClass = `lang-${state.currentLang}`;
                        const verseClass = `verse ${isBibleVerse ? 'bible-verse' : ''} ${state.currentLang === 'text_odia' ? 'odia-text' : ''} ${langClass}`;
            ...
            // Hide navigation buttons after 3 seconds
            dom.prevBtn.classList.remove('hidden');
            dom.nextBtn.classList.remove('hidden');
            setTimeout(() => {
                dom.prevBtn.classList.add('hidden');
...
async function loadBook(bookKey) {
    ...
    // --- ETERNAL LIFE LOADING ---
        ...
        console.log(`Loading Eternal Life in language: ${fileName}`);
        ...
        if (!books['eternal_life'] || !books['eternal_life'].chapters || books['eternal_life'].chapters.length === 0) {
            console.error("Eternal Life data could not be loaded. Creating minimal fallback structure.");
            books['eternal_life'] = {
                title: "Eternal Life",
                chapters: [{
                    title: "Error Loading Content",
                    isCover: false,
                    verses: [{ text: "The book content could not be loaded. Please ensure you are running the app through a local web server (using http:// or https://) rather than opening the file directly (using file://) to avoid CORS restrictions." }]
                }]
            };
        }
    ...
    if (mode === 'bookmarks') {
        ...
        state.bookmarks.forEach((bm, index) => {
            ...
            div.innerHTML = `
                ...
                <span class="delete-bm" onclick="removeBookmark(event, ${index})">\u1f5d1\ufe0f</span>
            `;
            div.onclick = (e) => {
...
function toggleSettings() {
    dom.settings.classList.toggle('show');
}
...
function disableUnavailableLanguages() {
    ...
    for (let i = 0; i < selector.options.length; i++) {
        ...
        if (config && config.unavailable) {
            ...
            // Remove (Unavailable) if present (simplified check)
...
async function startQuiz() {
    ...
    // Update the scoreboard display immediately
    updateScoreBoard();
    ...
    try {
        ...
        // FIX: Pass the current language to ensure we don't load cached questions from a different language
        ...
        alert('Failed to load quiz data for this language. Please ensure the quiz file exists.');
...
function renderQuestion() {
    if (state.quizIndex >= window.currentQuizQuestions.length) {
        endGame(); // Passed true to indicate potential win
        return;
    }
    ...
    if (hintBtn) {
        if (state.quizIndex === 0) {
            // Disable hint for first question
            hintBtn.disabled = true;
            hintBtn.innerText = "💡 Hint Unavailable";
        } else {
            // Enable hint for subsequent questions
            hintBtn.disabled = false;
            hintBtn.innerText = `💡 Hint (Cost: ${state.quizScore} points)`;
        }
    }
    ...
    // We search the shuffled array for the item that matches the JSON's correct answer index
    ...
    optionsWithIndex.forEach((optObj, idx) => {
        ...
        btn.dataset.originalIndex = optObj.originalIndex; // Store original index for hint logic

        // Display the text from our shuffled object
        btn.innerHTML = `<span class="letter">${letters[idx]}:</span> <span class="option-text">${optObj.text}</span>`;

        // Pass the current loop index (idx) and the correct VISUAL index
    ...
    if (progressFillEl) progressFillEl.style.width = `${(state.quizIndex + 1) * (100 / 30)}%`;
    // --- LOGIC FIX END ---
}
...
function endGame(wonAll) {
    ...
    let finalPrize = state.quizScore;
    const playAgainContainer = document.getElementById('playAgainContainer');
    if (wonAll) {
        document.getElementById('finalScoreText').innerText = `CONGRATULATIONS! You are a Bible Scholar!\nPrize: $${finalPrize.toLocaleString()}`;
        if (playAgainContainer) playAgainContainer.style.display = 'none';
    } else {
        document.getElementById('finalScoreText').innerText = `Game Over.\nYou take home: ${finalPrize.toLocaleString()} coins`;
...
async function loadQuizData() {
    // CRITICAL: Re-read language state from localStorage to ensure we have the ABSOLUTE latest value
    // This prevents stale state from being used
    const freshPreferredLang = localStorage.getItem('myReaderPreferredLang') || 'text';

    console.log(`🎮 QUIZ LOAD START - state.currentLang: "${state.currentLang}", state.preferredLang: "${state.preferredLang}", localStorage: "${freshPreferredLang}"`);

    // ALWAYS use the freshest value available
    let langToUse = state.currentLang || freshPreferredLang;

    // Ensure we're using the preferred lang if it's been set
    if (freshPreferredLang && freshPreferredLang !== 'text') {
        langToUse = freshPreferredLang;
    }

    let currentQuizLanguage = 'english';
    if (langToUse === 'text') {
        currentQuizLanguage = 'english';
    } else if (langToUse && langToUse.startsWith('text_')) {
        currentQuizLanguage = langToUse.replace('text_', '');
    } else {
        currentQuizLanguage = 'english';
    }

    const storageKey = `quiz_${currentQuizLanguage}`;
    let data = null;

    console.log(`🎯 QUIZ RESOLVED: "${currentQuizLanguage}" (from "${langToUse}")`);

    // 1. Fetch from Local File
    let quizFileName = 'quiz_english';
    if (currentQuizLanguage && currentQuizLanguage !== 'english') {
        quizFileName = `quiz_${currentQuizLanguage}`;
    }

    const cacheBuster = Date.now();
    let url = `quiz/${quizFileName}.json?t=${cacheBuster}`;
    console.log(`Attempting to fetch: ${url}`);

    try {
        let response = await fetch(url);

        // Retry without cache buster if needed
        if (!response.ok && response.status !== 0) {
            console.warn(`Fetch failed (${response.status}), retrying clean URL...`);
            url = `quiz/${quizFileName}.json`;
            response = await fetch(url);
        }

        if (response.ok || response.status === 0) {
            let tempText = await response.text();
            console.log(`[QUIZ-DEBUG] Response length: ${tempText.length}`);
            console.log(`[QUIZ-DEBUG] Response preview: ${tempText.substring(0, 50)}...`);
            ...
            if (tempText && tempText.trim().length > 0) {
                try {
                    ...
                    if (data.quizTitle && Array.isArray(data.questions)) {
                        BibleStorage.saveBible(storageKey, data).catch(e => console.error(e));
                        return { quizTitle: data.quizTitle, questions: data.questions };
                    } else {
                        throw new Error("Invalid JSON Structure (Missing title/questions)");
                    }
                } catch (parseError) {
                    console.error("JSON Parse Error:", parseError);
                    alert(`Error parsing quiz for ${currentQuizLanguage}:\n${parseError.message}`);
        ...
        console.error(`Failed to load ${currentQuizLanguage}:`, error);

        // EXPLICIT ERROR ALERT FOR USER
        if (currentQuizLanguage !== 'english') {
            alert(`Failed to load quiz for language: ${currentQuizLanguage}\nReason: ${error.message}\n\nFalling back to English.`);
        }
    }

    // 3. Fallback to English
    if (quizFileName !== 'quiz_english') {
        try {
            const response = await fetch('quiz/quiz_english.json');
            if (response.ok) {
                data = await response.json();
                return { quizTitle: data.quizTitle, questions: data.questions };
            }
        } catch (e2) {
            console.warn("English fallback failed:", e2);
        }
    }

    // 4. Final Fallback
    return {
        quizTitle: 'Bible Quiz (Offline)',
...
function updateScoreBoard() {
    ...
    if (scoreElement) {
        scoreElement.innerText = state.quizScore.toLocaleString();
    }
}

// --- HINT LIFELINE FUNCTION ---
function useHint() {
    if (state.hintUsed) {
        alert("You've already used your hint lifeline this question!");
        return;
    }

    const hintCost = state.quizScore;
    if (hintCost <= 0) {
        alert("You need points to use the hint lifeline!");
        return;
    }

    // Deduct current score
    state.quizScore -= hintCost;
    updateScoreBoard();
    ...
    if (hintBtn) {
        hintBtn.disabled = true;
        hintBtn.innerText = "💡 Hint Used";
    }

    // Provide the hint - eliminate one wrong answer
    const qData = window.currentQuizQuestions[state.quizIndex];
    const optionsGrid = document.getElementById('optionsGrid');
    const optionBtns = optionsGrid.querySelectorAll('.option-btn');

    // Find wrong buttons directly
    const wrongBtns = Array.from(optionBtns).filter(btn => parseInt(btn.dataset.originalIndex) !== qData.correctAnswer);


    // Shuffle wrong buttons to randomize which ones are eliminated
    ...
    const eliminationText = eliminatedCount === 1 ? 'One wrong answer has been eliminated' :
        eliminatedCount === 2 ? 'Two wrong answers have been eliminated' :
            'Wrong answers have been eliminated';

    document.getElementById('quizFeedback').innerText = `Hint used! ${eliminationText}. Your score is now ${state.quizScore.toLocaleString()} coins.\n\nRemember, you can only use the hint once per question!`;
...
async function changeLanguage(langKey) {
    ...
    try {
        ...
        console.log(`Resetting currentTranslationId (was ${state.currentTranslationId}) to null to ensure fresh language load.`);
        ...
        // 3. Load the Content
        if (state.currentBookKey === 'bible') {
            // Pass true to keepLoading so we don't flash content
 ...
 */
async function loadBibleForCurrentLanguage(langKey, keepLoading = false, targetVersionId = null) {
        ...
        if (typeof BibleStorage !== 'undefined') {
            ...
            if (localBible) {
                ...
                if (versionMismatch) {
                    ...
                    showLoading(`Loading ${langKey} (Offline)...`);
                    hideLoading();
    ...
    showLoading(`Loading ${config.message ? 'Bible' : langKey}...`);
    ...
    // UPDATE BODY CLASS FOR GENERIC LANGUAGE STYLING
    updateLanguageBodyClass(langKey);
    ...
    for (const source of activeSources) {
        try {
            ...
            if (source.type === 'BOLLS') {
                ...
                const booksList = await api.getBooks(source.id);
                if (!booksList || booksList.length === 0) throw new Error('No books found');
                ...
                console.log(`Fetching from LOCAL_BIBLE: ${source.path}`);
                const booksUrl = `${source.path}/books.json`;
                ...
                state.currentTranslationId = data.translation.id;
                loaded = true;
            ...
            if (loaded) {
                ...
                if (LOCALIZED_BIBLE_TITLES[langKey]) {
...
// Mapping from HELLOAO book ID codes to bibleBookNames index (0-based)
...
function populateBibleBooks() {
    ...
    if (!bookSelect || !books['bible']) return;
...
function populateBibleVerses() {
    ...
    currentChapter.verses.forEach((v, index) => {
        ...
        if (v.verseId !== null && v.verseId !== undefined) {
            ...
            verseNum = index + 1; // Fallback to index
        }
...
function onBibleVerseChange() {
    ...
    if (verseNumber > 0) {
        // Await the rendering so the DOM is ready before we try to highlight/scroll
        renderChapter().then(() => {
...
function highlightVerse(verseNumber) {
    ...
    // FIX: Find the verse element by matching the ID suffix or content, don't rely on index
    // because some verses might be missing or there might be headers.
    let targetElement = null;

    // 1. Try finding by ID suffix (safest)
    const suffix = `:${verseNumber}`;
    ...
    // 2. Fallback: Try matching the displayed number
    if (!targetElement) {
        for (let i = 0; i < verseElements.length; i++) {
            const numSpan = verseElements[i].querySelector('.verse-number');
            if (numSpan && numSpan.textContent.trim() === String(verseNumber)) {
                targetElement = verseElements[i];
                break;
            }
        }
    ...
    // 3. Last resort: Index (if complete Bible)
    if (!targetElement && verseElements[verseNumber - 1]) {
        targetElement = verseElements[verseNumber - 1];
    }
    ...
    if (targetElement) {
        ...
        verseElements.forEach(el => el.classList.remove('highlighted'));

        // Add highlight to selected verse and scroll to it
        targetElement.scrollIntoView({ behavior: 'smooth', block: 'center' });
        targetElement.classList.add('highlighted');

        // Set extended timeout to remove highlight (5 seconds)
    ...
    // Update Bible reference display after verse change
    updateBibleReferenceDisplay();
}
...
function disableUnavailableLanguages() {
    ...
    for (let i = 0; i < selector.options.length; i++) {
        ...
        // 5. Handle Unavailable Status
        if (config && (config.unavailable === true || (config.sources && config.sources.length === 0))) {
            if (isBible) {
                // WARN: Only hide if strictly unavailable and we are in Bible mode?
                // Actually, let's log this to be sure
                // console.log(`Hiding ${langKey} because it is marked unavailable.`);
                option.style.display = 'none'; // Hide completely in Bible mode
            } else {
                newLabel += " (Unavailable)"; // Show tag if visible elsewhere (borrowed logic)
            }
        }
                    ...
                    if (ch.isLoaded === false || !ch.verses || ch.verses.length === 0) {
                        ...
                        try {
                            ...
                            if (!ch.apiLink && bibleData.translationId) {
                                ...
                                } else if (bibleData.sourceType === 'LOCAL_BIBLE' && bibleData.localPath) {
                                    ch.apiLink = `${bibleData.localPath}/${ch.bookId}/${ch.chapterNumber}.json`;
                                } else {
...
function showAbout() {
    ...
    let html = `
        ...
        <div class="ai-disclaimer" style="background: rgba(255,165,0,0.1); padding: 10px; border-radius: 8px; margin-bottom: 15px; border-left: 3px solid orange;">
            <strong>AI Disclaimer:</strong> Chat responses are generated by LLaMA 3.1 AI (via Groq). 
            Information provided by the AI may not be accurate. Please verify all spiritual answers with the Holy Scripture.
        </div>
...
/**
 * Updates the document body class to include a generic language class.
 * This allows specialized CSS styling per language (e.g. .lang-text_dutch).
 * @param {string} langKey - The language key (e.g., 'text_dutch').
 */
function updateLanguageBodyClass(langKey) {
    // Remove any existing lang- classes to prevent accumulation
    const classes = document.body.className.split(" ").filter(c => !c.startsWith("lang-"));
    document.body.className = classes.join(" ");

    // Add the new language class if valid
    if (langKey) {
        document.body.classList.add(`lang-${langKey}`);
    }
}
        ...
        try {
            ...
            req.onsuccess = function (e) {
                ...
                if (dbase.objectStoreNames.contains('chapters')) {
                    ...
                    const deleteReq = store.delete(keyRange);
                    deleteReq.onsuccess = () => {
                        // console.log("Cleared Odia cache successfully");
                        dbase.close();
                    };
                    deleteReq.onerror = () => dbase.close();
                } else {
                    dbase.close();
                }
            };
            req.onerror = () => console.error("Could not open DB for clearing cache");
        } catch (e) { console.error("Error clearing odia cache", e); }
    }
}
// --- APP INITIALIZATION ---
...
window.initApp = async function () {
    ...
    setTimeout(async () => {
        try {
            ...
            if (state.currentBookKey !== 'quiz' && state.currentBookKey !== 'chat') {
                await renderChapter();
            }
        } catch (err) {
        ...
        if (state.currentBookKey === 'bible') {
            if (state.savedBibleBookName && state.savedBibleChapterNumber) {
                // await restoreBibleNavigation(); // Assuming this was defined or logic is covered
                // Actually, renderChapter might handle this if state is set?
                // But let's keep it if functions exist.
                if (typeof restoreBibleNavigation === 'function') await restoreBibleNavigation();
            }
        }

        // 5. Highlight Verse if needed
        if (state.currentVerseNumber > 0) {
            setTimeout(() => {
...
function onBackKeyDown(e) {
    if (document.getElementById('aboutPopup') && document.getElementById('aboutPopup').style.display === 'block') {
        closeAboutPopup();
        e.preventDefault();
    } else if (document.getElementById('settingsPanel') && document.getElementById('settingsPanel').classList.contains('open')) {
        toggleSettings();
        e.preventDefault();
